...
public class MainMenu extends Page {
    ...
    public void initialize() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(PotadoShack.class.getClassLoader().getResource("layouts/views/ViewMeals.fxml"));
    ...
    public void selectView(View view) {
        ...
        if (type.equals(View.Type.MEALS)) {
            loader = new FXMLLoader(PotadoShack.class.getClassLoader().getResource("layouts/views/ViewMeals.fxml"));

            selectedButton = btn_meals;
        } else if (type.equals(View.Type.CART)) {
            loader = new FXMLLoader(PotadoShack.class.getClassLoader().getResource("layouts/views/ViewCart.fxml"));

            selectedButton = btn_cart;
        } else if (type.equals(View.Type.ORDERS)) {
            loader = new FXMLLoader(PotadoShack.class.getClassLoader().getResource("layouts/views/ViewOrder.fxml"));

            selectedButton = btn_orders;
        } else if (type.equals(View.Type.SETTINGS)) {
            loader = new FXMLLoader(PotadoShack.class.getClassLoader().getResource("layouts/views/ViewSettings.fxml"));
